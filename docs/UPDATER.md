...
```powershell
.\scripts\create-updater-release-assets.ps1 -Version 0.1.1 -Notes "Notas de la version"
```
...
gh release create app-v0.1.1 `
  ...
  target\release\bundle\release-assets-0.1.1\CINE.WANA_0.1.1_x64-setup.exe `
  target\release\bundle\release-assets-0.1.1\CINE.WANA_0.1.1_x64-setup.exe.sig `
  target\release\bundle\release-assets-0.1.1\latest.json `
  --title "CINE WANA v0.1.1" `
