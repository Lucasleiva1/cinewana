...
export function App() {
  ...
  const playMedia=async(id:string)=>{try{setError(null);await invoke('player_command',{command:{type:'play',media_id:id}});}catch(cause){setError(`No se pudo reproducir: ${String(cause)}`);}};
  ...
  return <div className="app-shell">
    ...
    {detail&&<DetailModal detail={detail} close={()=>setDetail(null)} setFlag={setFlag} playMedia={playMedia}/>}
  </div>;
}
