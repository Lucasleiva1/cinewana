...
describe('next-up playback policy', () => {
  it('opens the offer at 60 seconds and counts down to the real ending', () => {
    expect(shouldOfferNextUp(39.9, 100, true, false)).toBe(false);
    expect(shouldOfferNextUp(40, 100, true, false)).toBe(true);
